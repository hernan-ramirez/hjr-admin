<?php
/**
 * Table Definition for futbol_partidos
 */
require_once 'DB/DataObject.php';

class DataObjects_Futbol_partidos extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'futbol_partidos';                 // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Futbol_partidos',$k,$v); }

    /* the code above is auto generated do not remove the tag below */
    ###END_AUTOCODE
	
	var $fieldLavel = array(
		'goles_primer_club' => 'Goles Locales',
		'goles_segundo_club' => 'Goles Visitante'
	);
}
?>
