<?php
/**
 * Table Definition for tenis_resultados
 */
require_once 'ModelDB/Tenis_campeonatos.php';

class DataObjects_Tenis_resultados extends DataObjects_Tenis_campeonatos 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'tenis_resultados';                // table name
    var $id;                              // int(11)  not_null primary_key auto_increment
    var $id_campeonato;                   // int(10)  not_null
    var $id_instancia;                    // int(10)  
    var $id_primer_jugadoratp;            // int(10)  not_null
    ...
    var $id_segundo_jugadoratp;           // int(10)  not_null
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Tenis_resultados',$k,$v); }
