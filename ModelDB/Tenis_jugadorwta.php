<?php
/**
 * Table Definition for tenis_jugadorwta
 */
require_once 'ModelDB/Tenis_campeonatos.php';

class DataObjects_Tenis_jugadorwta extends DataObjects_Tenis_campeonatos 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    var $__table = 'tenis_jugadorwta';                // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Tenis_jugadorwta',$k,$v); }
